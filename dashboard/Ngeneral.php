        ...
        <div id="Ngeneral-container">
            <div class="table-responsive">
                <table class="table table-striped" description="tabla noticias">
                  ...
                  <tbody>
                    <!-- ACA ESTARAN LAS NOTICIAS DINAMICAMENTE QUE SE CARGAN CON
                     JS,AJAX PARA ESTE CASO LOS TENGO EN UN JSON , PERO PODRIA CARGARLOS CON UNA API SI ASI QUISIERA-->
                  </tbody>
                </table>
                <video controls>
